      ...
      <Card className="border-amber-500/30 bg-amber-500/5">
        <CardHeader className="flex-row items-center gap-3 space-y-0">
          ...
          <div>
            ...
            <CardDescription>
              La UI está lista. La activación se hará cuando el número esté verificado por Meta.
            </CardDescription>
          </div>
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 lg:grid-cols-2">
          ...
          <div className="grid gap-1.5 lg:col-span-2">
            ...
            <Input placeholder="https://api.smscnm.com/wa/webhook" />
          </div>
          <div className="grid gap-1.5 lg:col-span-2">
            <Label>Verify Token</Label>
            <Input placeholder="cnm_wa_verify" />
          </div>
        </CardContent>
      </Card>
    </AdminPage>
