      ...
      MODULES.map((m) => [
        ...
        Object.fromEntries(
          ACTIONS.map((a) => [
            a,
            r === "Super Admin" ||
              (r === "Admin Empresa" && a !== "Eliminar") ||
              (r === "Solo lectura" && a === "Ver"),
          ]),
        ),
      ]),
    ),
...
function PermisosPage() {
  ...
  const toggle = (m: string, a: string) =>
    setMatrix((prev) => ({
      ...prev,
      [role]: { ...prev[role]!, [m]: { ...prev[role]![m]!, [a]: !prev[role]![m]![a] } },
    }));
    ...
    <AdminPage
      ...
      actions={
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={() => toast.success("Permisos guardados")}>
            Guardar cambios
          </Button>
        </div>
      }
