...
const NOTIF = [
  {
    ...
    desc: "Cuando termina el envío de una campaña.",
  },
  {
    id: "billing",
    label: "Facturación y recargas",
    desc: "Alertas de saldo bajo y nuevos cargos.",
  },
  { id: "api", label: "Errores de API y webhooks", desc: "Fallos en integraciones y entregas." },
  {
    id: "security",
    label: "Alertas de seguridad",
    desc: "Inicios de sesión desde nuevos dispositivos.",
  },
];
