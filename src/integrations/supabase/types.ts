  ...
  public: {
    Tables: {
      ...
      contact_tag_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "contact_tag_members_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "contact_tag_members_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
      ...
      whatsapp_campaign_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_campaign_results_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "whatsapp_campaign_results_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
