...
-- Ensure we don't have duplicates before adding constraint
WITH duplicates AS (
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'whatsapp_templates_account_external_unique') THEN
